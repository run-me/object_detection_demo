...
class YOLO(object):
    ...
    def generate(self):
        ...
        assert model_path.endswith('.h5'), 'Keras model or model_data must be a .h5 file.'
        
        # Load model, or construct model and load model_data.
    ...
    def detect_image(self, image):
        ...
        predictions = [list(out_boxes), list(out_scores), list(out_classes)]
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            # TODO convert predictions to yolo relative format
